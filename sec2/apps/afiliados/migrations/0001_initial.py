    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razon_social', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator(code='invalid_text', message='Solo se permiten letras, números y espacios, con o sin tildes.', regex='^[A-Za-z0-9\\sñÑáéíóúÁÉÍÓÚ]+$')])),
                ('categoria_laboral', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(code='invalid_text', message='Solo se permiten letras, números y espacios, con o sin tildes.', regex='^[A-Za-z0-9\\sñÑáéíóúÁÉÍÓÚ]+$')])),
                ...
                ('domicilio_empresa', models.CharField(help_text='Calle y numero', max_length=50, validators=[django.core.validators.RegexValidator(code='invalid_text', message='Solo se permiten letras, números y espacios, con o sin tildes.', regex='^[A-Za-z0-9\\sñÑáéíóúÁÉÍÓÚ]+$')])),
