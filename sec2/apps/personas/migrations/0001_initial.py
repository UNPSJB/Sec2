# Generated by Django 4.1.1 on 2024-03-11 01:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.CharField(help_text='Calle y numero', max_length=50, validators=[django.core.validators.RegexValidator(code='invalid_text', message='Sin caracteres especiales.', regex='^[A-Za-z0-9\\sñÑ]+$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.PositiveSmallIntegerField(choices=[(3, 'alumno'), (2, 'profesor'), (2, 'familiar'), (1, 'afiliado'), (4, 'encargado')])),
